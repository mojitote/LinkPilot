            ...
            <div className="text-center">
              ...
              <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-8 max-w-2xl mx-auto">
                ...
                <p className="text-xs text-gray-400 mb-4">
                  <a href="/test-keys" className="text-blue-600 hover:underline">Debug: Test Keys Page</a>
                </p>
                
                <div className="space-y-4">
                  <button
                    onClick={() => signIn('github')}
                    className="w-full bg-gray-900 text-white px-8 py-4 rounded-xl hover:bg-gray-800 transition-colors flex items-center justify-center space-x-3 text-lg font-medium"
                  >
